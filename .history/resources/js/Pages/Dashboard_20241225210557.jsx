...
export default function Dashboard() {
    ...
    return (
        <AuthenticatedLayout
            header={
                <h2 className="text-2xl font-bold leading-snug text-gray-800 border-b-4 border-indigo-500 pb-2">
                Dashboard
            </h2>
                        ...
                        <div className="p-6 text-gray-900">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">{auth.user.date_of_birth}</p>
                                </div>
                                <div>
                                    <h5 className="font-medium text-gray-700">Phone:</h5>
                                    <p className="text-gray-600">{auth.user.phone}</p>
                                </div>
                            </div>
                        </div>
                    </div>
