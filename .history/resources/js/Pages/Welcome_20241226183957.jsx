...
<section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <img src="/images/appointment.jpg" alt="Appointment Scheduling" className="w-48 h-48 mx-auto mb-4" />
    ...
    <Link
        href={route('appointmentForm.jsx')} // Ensure this matches the route name in your Laravel routes
